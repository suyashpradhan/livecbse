...
<table id="hor-minimalist-b" width="560" height="200" style="background-color:#e1e1e1; line-height:50px;">
...
<tr><td colspan="2" align="right">
      <table cellspacing="0" style="font-size:12px; line-height:20px; padding-right:30px;">
				...
				<tr>
					<td style="border-bottom:1px solid #000000; border-right:solid 1px black;"><span >GST</span></td>
...
<input type="button" class="but-register" id="register" name="register"  value="PAY NOW" onClick="pay_now();"></a></td></tr>
</table>
</body>
</html>
