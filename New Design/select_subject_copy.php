...
<h1 class="select-subject-text">Please select Mathematics or Biology</h1>
                <div class="select-div">
                    <div class="checkboxes">
                        <label class="pure-material-checkbox">
                            <input type="checkbox" name="Physics" id="Physics" value="p" checked="checked"
                                disabled="disabled" onDblClick="fun_uncheck('Physics');">
                            <span>Physics</span>
                        </label>
                    </div>
                    <div class="checkboxes">
                        <label class="pure-material-checkbox">
                            <input type="checkbox" name="Chemistry" id="Chemistry" value="c" onClick="get_fee();"
                                disabled="disabled" onDblClick="fun_uncheck('Chemistry');" checked="checked"
                                onClick="get_fee();">
                            <span>Chemistry </span>
                        </label>
                    </div>
                    <div class=" checkboxes">
                        <label class="pure-material-checkbox">
                            <input type="checkbox" name="English" disabled="disabled" id="English" value="e"
                                onClick="get_fee();" onDblClick="fun_uncheck('English');" onClick="get_fee();"
                                checked="checked">
                            <span>English</span>
                        </label>
                    </div>
                    <div class="md-radio-new">
                        <input type="radio" name="sub" id="Maths" value="m" onClick="get_fee();"
                            onDblClick="fun_uncheck('Maths');">
                        <label for="Maths" class="md-radio-text">Maths</label>
                    </div>
                    <div class="md-radio-new">
                        <input type="radio" name="sub" id="Biology" value="b" onClick="get_fee();"
...
<input type="button" class="btn btn-dark" id="register" name="register"  value="Proceed" onClick="pay_now();"></a>
